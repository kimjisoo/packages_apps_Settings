...
public class StatusBarClockStyle extends SettingsPreferenceFragment
    ...
    private SwitchPreference mSecondClock;
    ...
    private PreferenceScreen createCustomView() {
        ...
        mSecondClock = (SwitchPreference) prefSet.findPreference(CLOCK_USE_SECOND);
        mSecondClock.setChecked((Settings.System.getInt(
                getActivity().getApplicationContext().getContentResolver(),
                Settings.System.CLOCK_USE_SECOND, 1) == 1));
        mSecondClock.setOnPreferenceChangeListener(this);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            return true;
        } else if (preference == mSecondClock) {
            Settings.System.putInt(getActivity().getApplicationContext().getContentResolver(),
